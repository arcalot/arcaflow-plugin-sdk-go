...
func TestMapMin(t *testing.T) {
	...
	assert.ErrorR[any](t)(mapType.Unserialize(map[any]any{}))
	assert.ErrorR[any](t)(mapType.Unserialize(map[any]any{"foo": "foo"}))
	...
	assert.ErrorR[any](t)(mapType.Serialize(map[string]string{}))
	assert.ErrorR[any](t)(mapType.Serialize(map[string]string{"foo": "foo"}))
...
func TestMapMax(t *testing.T) {
	...
	assert.ErrorR[any](t)(mapType.Unserialize(map[any]any{"foo": "foo", "bar": "bar", "baz": "baz"}))
	unserialized, err := mapType.UnserializeType(map[any]any{"foo": "foo", "bar": "bar"})
	assert.NoError(t, err)
	assert.Equals(t, 2, len(unserialized))
	assert.Equals(t, "foo", unserialized["foo"])
	...
	assert.ErrorR[any](t)(mapType.Serialize(map[string]string{"foo": "foo", "bar": "bar", "baz": "baz"}))
	serialized, err := mapType.Serialize(map[string]string{"foo": "foo", "bar": "bar"})
	assert.NoError(t, err)
	serializedMap := serialized.(map[any]any)
	assert.Equals(t, 2, len(serializedMap))
...
func TestMapItemValidation(t *testing.T) {
	...
	assert.ErrorR[any](t)(mapType.Unserialize(map[string]string{"a": "b"}))
	assert.ErrorR[any](t)(mapType.Unserialize(map[string]string{"ab": ""}))
	...
	assert.ErrorR[any](t)(mapType.Serialize(map[string]string{"a": "b"}))
	assert.ErrorR[any](t)(mapType.Serialize(map[string]string{"ab": ""}))
...
func TestMapSchemaHandling(t *testing.T) {
	...
	assert.ErrorR[any](t)(mapType.Unserialize(struct{}{}))
	assert.ErrorR[any](t)(mapType.Unserialize(map[any]any{"a": struct{}{}}))
	assert.ErrorR[any](t)(mapType.Unserialize(map[any]any{struct{}{}: "a"}))
}
